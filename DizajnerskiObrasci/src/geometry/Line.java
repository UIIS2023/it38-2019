...
public class Line extends Shape {
	...
	public String toString() {
		return String.format("LINE_Startpoint_%1$s,%2$s_Endpoint_%3$s,%4$s_Color_%5$s,%6$s,%7$s", this.startPoint.getX(),this.startPoint.getY(),
				this.endPoint.getX(),this.endPoint.getY(),this.getColor().getRed(),this.getColor().getGreen(),this.getColor().getBlue());
	}
